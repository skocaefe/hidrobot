...
# Hazır reçete şablonları (anyon-katyon dengeli)
RECETE_SABLONLARI = {
    "Marul": {
...
iyon_bilgileri = {
    "NO3": {"ad": "Nitrat", "eksik": "Yapraklarda sararma, bitki gelişiminde yavaşlama", "fazla": "Aşırı vejetatif büyüme, çiçeklenme ve meyve oluşumunda gecikme"},
    "H2PO4": {"ad": "Fosfat", "eksik": "Koyu yeşil/mor yapraklar, kök ve çiçek gelişiminde yavaşlama", "fazla": "Çinko ve demir alımını engelleme"},
    "SO4": {"ad": "Sülfat", "eksik": "Yeni yapraklarda sararma, protein sentezinde yavaşlama", "fazla": "Yüksek tuzluluk, diğer elementlerin alımında azalma"},
    "NH4": {"ad": "Amonyum", "eksik": "Protein sentezinde yavaşlama", "fazla": "Kök gelişiminde zayıflama, toksik etki, pH düşüşü"},
    "K": {"ad": "Potasyum", "eksik": "Yaprak kenarlarında yanma, zayıf kök gelişimi", "fazla": "Magnezyum ve kalsiyum alımını engelleyebilir"},
    "Ca": {"ad": "Kalsiyum", "eksik": "Çiçek ucu çürüklüğü, genç yapraklarda deformasyon", "fazla": "Fosfor alımını engelleyebilir"},
    "Mg": {"ad": "Magnezyum", "eksik": "Yaşlı yapraklarda sararma, klorofil azalması", "fazla": "Kalsiyum ve potasyum alımında azalma"},
    "Fe": {"ad": "Demir", "eksik": "Genç yapraklarda kloroz", "fazla": "Yapraklarda bronzlaşma"},
    "B": {"ad": "Bor", "eksik": "Büyüme noktalarında ölüm", "fazla": "Yaprak kenarlarında yanma"},
    "Mn": {"ad": "Mangan", "eksik": "Yapraklarda sararma", "fazla": "Nekroz"},
    "Zn": {"ad": "Çinko", "eksik": "Bodur büyüme", "fazla": "Demir alımının engellenmesi"},
    "Cu": {"ad": "Bakır", "eksik": "Yapraklarda solgunluk", "fazla": "Kök gelişiminde inhibisyon"},
    "Mo": {"ad": "Molibden", "eksik": "Azot eksikliği belirtileri", "fazla": "Nadiren toksik etki"}
}
...
MIKRO_GUBRE_BILGILERI = {
    "Demir EDDHA %6": {"Fe": 1, "molekul_agirligi": 435.0},
...
def create_pdf(recete, a_tank_sonuc, b_tank_sonuc, mikro_sonuc):
    ...
    if not os.path.exists(PDF_FONT_PATH):
        raise FileNotFoundError(f"Font dosyası bulunamadı: {PDF_FONT_PATH}")
